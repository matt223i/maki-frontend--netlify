...
import { Button } from 'maki-toolkit-v2'
...
export default function TableLimitOrder({ modalAction }: TableLimitOrderProp) {
  ...
  const { orders } = useSelector<AppState, AppState['limit']>((s) => s.limit)
