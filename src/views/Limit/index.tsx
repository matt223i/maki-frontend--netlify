...
import { Card as LimitCard, Flex, CardBody, ArrowDownIcon, Button, IconButton, Text } from 'maki-toolkit-v2'
...
const LimitContainer = styled(Flex)`
...
const LimitBody = styled(LimitCard)`
  min-width: 400px;
  position: relative;
  max-width: 436px;
  width: 100%;
