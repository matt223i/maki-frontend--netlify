...
import { Modal, Text, Flex, Box, Button } from 'maki-toolkit-v2'
    ...
    <Modal title={t('MAKI HT CLAIM')} onDismiss={onDismiss}>
      <Flex justifyContent="center">
        <Box maxWidth="320px">
          <Text fontSize="14px">
            {t(
              'Enter an address to trigger a HT claim. If the address has any claimable HT it will be sent to them on submission.',
            )}
          </Text>
